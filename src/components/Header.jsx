        ...
        <>
            ...
            <div className="min-h-[80vh] relative pt-[10px] 13inch:hidden">
                <>
                    ...
                    <div className="absolute sm:top-[137px] md:top-[71px]  lg:top-[45px] xl:top-[39px]  xs:top-[150px] xxs:top-[128px] top-[129px] left-0 flex  lg:h-[120vh] md:h-[102vh] sm:h-[90vh] xs:h-[80vh] h-[75vh] w-full items-center justify-center overflow-hidden 13inch:hidden">
                        <video
                            src={waveVideo}
                    ...
                    <div className="  py-[100px] lg:py-[200px] -z-0 text-center  !flex relative  items-center md:z-40  !justify-end ">
                        ...
                        <div className=" sm:max-w-[800px] z-40 text-white text-[22px] text-center mx-auto xs:text-[26px] sm:text-[30px] md:text-[33px]  leading-[36px] xs:leading-[40px] sm:leading-[48px] font-Roboto font-light" >At LlamaMind, We Lead in App Development, Using Cutting-Edge Tech to Shape the Digital Future. We Empower Businesses with Intelligent, Scalable Solutions for Growth and Smarter Decision-Making, Building a More Connected World.</div>
                    </div>
