...
function Header() {
    ...
    return (
        ...
        <>
            ...
            {/* smalll screen start */}
            <div className="min-h-[80vh] relative pt-[10px] 13inch:hidden">
                <>
                    <div className="pt-[200px] sm:pt-[250px] flex items-center justify-center mx-auto">
                    ...
                    <div className="absolute sm:top-[137px] md:top-[71px]  lg:top-[45px] xl:top-[39px]  xs:top-[150px] xxs:top-[129px] top-[129px] left-0 flex  lg:h-[120vh] md:h-[102vh] sm:h-[90vh] xs:h-[80vh] h-[75vh] w-full items-center justify-center overflow-hidden 13inch:hidden">
                        <video
                            src={waveVideo}
                        ...
                        <img className="absolute min-w-[450px] xs:w-auto h-[48vh] z-20 xs:h-[52vh] sm:h-[55vh] md:h-[65vh] lg:h-[73vh] xl:h-[80vh] md:max-w-[900px] md:bottom-[75px] lg:bottom-[140px] xl:bottom-[100px]  bottom-28" src={headerImage} alt="" />
                    </div>
                    ...
                    <div className='text-white  mt-[700px] xs:mt-[800px] sm:mt-[1000px] md:mt-[1100px] z-50 '>
                        ...
                        <div className=' flex  size-[150px] sm:size-[170px] -mt-[160px] sm:-mt-[220px] lg:-mt-[180px]  items-center justify-center mx-auto z-[50] group m-2 p-4 rounded-full relative transition-colors  duration-500 projectMovieCircel-gradient  hover:projectMovieCircel-gradient-hover backdrop-blur-xl shadow-[#5c5ca0] shadow-md'>
                    ...
                    <div className="  py-[100px] lg:py-[200px] -z-0 text-center  !flex relative  items-center md:z-40  !justify-end ">
                        ...
                        <div className=" w-[] sm:max-w-[800px] z-40 text-white text-[22px] text-center mx-auto xs:text-[26px] sm:text-[30px] md:text-[33px]  leading-[36px] xs:leading-[40px] sm:leading-[48px] font-Roboto font-light" >At LlamaMind, We Lead in App Development, Using Cutting-Edge Tech to Shape the Digital Future. We Empower Businesses with Intelligent, Scalable Solutions for Growth and Smarter Decision-Making, Building a More Connected World.</div>
                    </div>
