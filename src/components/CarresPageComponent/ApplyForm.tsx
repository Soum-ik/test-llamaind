            ...
            <form className="w-full max-w-[1020px] mx-auto font-Roboto  mt-[30px] text-white rounded-lg" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2  md:grid-rows-5 md:grid-flow-col gap-[20px]">
                    ...
                    <div className="row-span-2 md:-mt-5">
                        ...
                        <input
                            type="text"
                            className="w-full text-[20px] h-[174px] md:h-[85%] font-normal px-[20px] py-2 text-white rounded-lg bg-[#0A0A24] bg-opacity-[20%] border-[2px] border-[#ffffff] border-opacity-[8%]  focus:outline-none"
                        />
                    </div>
