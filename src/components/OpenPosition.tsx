...
function OpenPosition() {
    return (
        <div className="mx-auto relative z-30 xl:pt-0 xl:pb-[10px] pt-[60px]  ">
            <Layout>
                ...
                <div id="Position" className=" xl:hidden max-w-[355px] sm:max-w-[500px] md:min-w-[800px] absolute  left-1/2 transform -translate-y-1/2 -translate-x-1/2  z-40    w-full text-white ">
                    <div className=" ">
