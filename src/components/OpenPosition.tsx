...
function OpenPosition() {
    return (
        <div className=" relative z-40">
            <Layout>
                <div id="Position" className=" absolute top-[250px] left-1/2 transform -translate-y-1/2 -translate-x-1/2  z-40  pt-[140px]  text-white flex-col flex items-center justify-center">
