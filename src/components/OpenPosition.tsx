...
function OpenPosition() {
    return (
        <div className="mx-auto relative z-30 xl:pt-0 xl:pb-[10px] pt-[110px] pb-[300px] sm:pb-[230px]  md:pb-[150px] lg:pb-[100px] ">
            <Layout>
                <div className=" hidden 13inch:flex  absolute  min-w-[700px] 2xl:w-[1000px] top-0 left-1/2 transform -translate-y-1/2 -translate-x-1/2  z-40    text-white flex-col  items-center">
                ...
                <div className=" 13inch:hidden max-w-[355px] xs:max-w-[400px] sm:max-w-[500px] md:min-w-[750px] absolute  left-1/2 transform -translate-y-1/2 -translate-x-1/2  z-40   w-full text-white ">
                    <div className=" ">
                        ...
                        <a href="/career"> <button className=" px-[32px] py-[18px] text-[20px]    bg-gradient-to-r to-[#6CB1FF] from-[#5D5CE8] hover:from-[#3534C0] hover:to-[#06FFDF]  13inch:hidden  mt-2 md:max-w-max left-1/2 -translate-x-1/2 w-full mx-auto absolute font-Roboto font-bold rounded-lg">View Open Positions</button></a>
                    </div>
                </div>
            </Layout>
        </div>
